        ...
        <div className="login">
            ...
            <h4>Welcome to Daraz! Please Sign in</h4>
                    ...
                    <Button onClick={signIn} className="loginButton">
                        ...
                        <Button onClick={fsignIn} className="loginButton">
                        <img className="login__btnGoogle"  src="https://www.flaticon.com/svg/static/icons/svg/2111/2111450.svg" alt=""/>Sign in with Facebook</Button>
